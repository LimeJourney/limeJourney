    ...
    <section className="py-20 bg-[#e7f0ef] overflow-hidden">
      <div className="container mx-auto px-4 relative">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            <img
              src="/segmentation-screenshot.png"
              alt="NFC Labels Showcase"
              className="w-full h-auto rounded-lg shadow-2xl"
            />
            <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-lg shadow-lg">
              <span className="text-4xl font-bold text-forest-600">+43%</span>
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8">
              LimeJourney allows you to segment your audience based on their
              preferences, behavior, and other criteria. This helps you to
              deliver more relevant content and offers to the right people at
              the right time.
            </p>
            <div className="space-y-4 mb-8">
              <FeatureItem text="Create custom segments based on user behavior" />
              <FeatureItem text="Target specific groups with personalized content" />
              <FeatureItem text="Analyze and improve your campaigns with data" />
            </div>
            <motion.button
              className="bg-forest-600 text-white px-6 py-1 rounded-full font-semibold flex items-center space-x-2 hover:bg-forest-700 transition duration-300"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              <span>Start Audience Segmentation</span>
              <ArrowRight size={20} />
            </motion.button>
          </motion.div>
        </div>
