        ...
        <div className="relative z-10 container mx-auto px-8 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-meadow-100 mb-6">
                LimeJourney was born from a real need I encountered while
                running Teal. I needed a way to communicate with customers at
                the right time, triggered by specific actions. However, existing
                tools posed two major challenges:
              </p>
              <ul className="list-disc list-inside text-meadow-200 mb-6 space-y-2">
                <li>
                  High costs that didn't scale well for growing businesses
                </li>
                <li>
            ...
            >
              ...
              <div className="bg-forest-700 rounded-lg p-8 shadow-xl">
                ...
                <p className="text-meadow-200 mb-6">
                  While we're currently a one-person show, we're excited about
                  the future and potential growth of LimeJourney. Be part of
                  something extraordinary - try our demo or contribute to our
                  open-source project.
                </p>
                <div className="space-y-4">
          ...
          >
            <p className="text-xl italic text-meadow-300 mb-4">
              ...
              transform your business communication. Let's connect and explore
